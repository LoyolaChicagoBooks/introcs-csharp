...
class StrangeSequence
{
   ...
   /**
    ...
    stopping when the latest value is 1.  Print each value.  Exanples:
    ...
    * CountStrangeSequence(1) returns 1; CountStrangeSequence(6) returns 6.
    */
   ...
   {
      int n = InputInt("Enter a positive integer: ");
      Console.WriteLine(n);
   ...
   // utility input functions follow
