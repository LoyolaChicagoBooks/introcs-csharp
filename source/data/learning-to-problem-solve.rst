...
This section could have been placed earlier, 
but after reading this far, 
...
It might be different from what you needed in situations 
where *rote* recall was the main goal.
...
The goal of this course is *not* to regurgitate the book, but to learn to solve problems
(generally involving producing a computer program).  
In this highly connected world
you have access to all sorts of information.  The information is not an end in itself;
the goal is to use the available tools to solve new problems.

In this course there is a lot of information tied to syntax and library function names.  
It can seem overwhelming.  It need not be.
...
- If you need some syntax to solve a simple early problem, 
  ...
  If you keep some of the old lists, you will be amazed how much material that you sweated over
...
Memorizing syntax is not going to directly solve real problems.  In any domain:
...
and maybe not things that you have memorized.  What *is* important for breaking down a problem
and planning a solution is knowing the basic *capacities* you have in programming.  As you get 
...
- There are basic operations you can do with the data (arithmetic, concatenating strings,
...
- You will see shortly that you have more tools: decisions, repetition, more built-in
  ways to deal with data, and creating your own data types.
...
So far, basic ideas for planning a solution have been discussed, and you can see that you do not
need to think of everything at once or have everything equally prominent in your brain.

Also, when you are coding, you do not need to have all the details of syntax in your head,
...
and maybe have the compiler misinterpret later parts and give bogus error messages.  
...
and low-value information, and have it all fade into oblivion, or be next to 
...
- Does this example fit into some larger idea, abstraction, or generalization in a way that
...
Keep coming back to this section and check up on your process.  It is important.
