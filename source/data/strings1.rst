...
~~~~~~~~~~~~~~~~~~~~~~
In a scratch program, declare and initialize a string variable.  Write an expression that
...
*Think* what each expression prints. Write one predicted response at a time, 
*then* test it,
